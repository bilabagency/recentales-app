        ...
        <div className="flex items-center justify-between h-14 px-4 max-w-lg mx-auto">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-slate-800/50 transition-colors"
            >
              <div className="w-6 h-6 rounded-full bg-slate-800 flex items-center justify-center text-slate-300 font-bold text-[10px] uppercase">
                {profile?.full_name?.slice(0, 2) || "?"}
              </div>
              <span className="text-xs font-medium max-w-[80px] truncate hidden sm:inline">
                {profile?.full_name || ""}
              </span>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 text-slate-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
